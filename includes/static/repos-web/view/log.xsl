	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				...
				<link title="repos" rel="stylesheet" type="text/css" href="../../../../public/static/repos-web/view/{$cssUrl}global.css"/>
				<link title="repos" rel="stylesheet" type="text/css" href="../../../../public/static/repos-web/view/{$cssUrl}log/log.css"/>
			</head>
			<body class="log xml">
