...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" version="1.0">
	...
	<xsl:param name="reposstyle-version">2.2</xsl:param>

	<!-- === repos style configuration === -->
	<!-- static: absolute url to style application -->
	<xsl:param name="static">/static/repos-web/</xsl:param>
	...
	<xsl:template name="styletag">
		<link rel="stylesheet" type="text/css" media="screen,projection" href="../../../../public/static/repos-web/view/{$cssUrl}global.css"/>
		<link rel="stylesheet" type="text/css" media="screen,projection" href="../../../../public/static/repos-web/view/{$cssUrl}repository/repository.css"/>
	</xsl:template>
	...
	<xsl:template name="commandbar">
		...
		<!-- <xsl:if test="/svn/index/updir"> -->
			<a id="parent" class="command translate" href="../../../../public/static/repos-web">up</a>
		<!-- </xsl:if> -->
